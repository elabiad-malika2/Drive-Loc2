    ...
    <div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <button class="mt-4 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 w-full" onclick="openEditModal(<?php echo $car['id']; ?>, '<?php echo $car['marque']; ?>', '<?php echo $car['modele']; ?>', '<?php echo $car['annee']; ?>', '<?php echo $car['prix']; ?>','<?php echo $car['id_categorie']; ?>')">
                Edit
            </button>
        </div>
    <?php endforeach; ?>
...
<div id="editCarModal" class="hidden fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center">
    <div class="bg-white w-2/3 p-5 rounded-lg shadow-lg h-[90%] overflow-y-auto">
        ...
        <form id="editCarForm" action="../../back-end/controller/modifierVoiture.php" method="POST" enctype="multipart/form-data">
...
<script>
    ...
    document.getElementById("editCategory").value = id_categorie;
}
