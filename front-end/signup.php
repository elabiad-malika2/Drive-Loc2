...
<h2 class="text-2xl font-semibold text-white text-center mb-6">Register</h2>
        ...
        <form action="../Back-end/controller/signup.php" method="POST">
            
            <div class="mb-4">
                <label for="nom" class="block text-white mb-2">Nom d'utilisateur</label>
                <div class=" bg-white/30 rounded-lg">
                <input type="text" id="nom" name="nom" placeholder="Votre nom" class="w-full placeholder-white/80 bg-transparent text-white flex-grow px-4 py-2 outline-none" required>
                </div>            
            </div>
            ...
            <div class="mb-4">
                ...
                <div class=" bg-white/30 rounded-lg">
                    <input type="password" id="mot_de_passe" name="password" placeholder="Votre mot de passe" class="w-full  placeholder-white/80 rounded-lg bg-transparent text-white flex-grow px-4 py-2 outline-none" required>
                </div>
            </div>
