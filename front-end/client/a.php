    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <article class="bg-white rounded-xl shadow-lg overflow-hidden card-hover">
                <div class="relative">
                    <img src="../../Back-end/controller/uploads/touareg.png" alt="Article" class="w-full h-48 object-cover">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Location de voitures électriques</h3>
                    <p class="text-gray-600 mb-4">Découvrez les avantages de la location de véhicules électriques pour vos déplacements écologiques.</p>
